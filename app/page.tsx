      ...
      <section className="max-w-6xl mx-auto px-6 mb-16">
        <div className="card" style={{ background: "white" }}>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-3">
            {[
              { label: "Walk", icon: PawPrint, href: "/book?service=WALKING", soon: false },
              { label: "Groom", icon: Scissors, href: "#", soon: true },
              { label: "Vet", icon: Stethoscope, href: "/owner/pets", soon: false },
              { label: "Sit", icon: HomeIcon, href: "/book?service=SITTING", soon: false },
